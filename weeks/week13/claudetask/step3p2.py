...
assert np.all(CL_samples > 0), "CL samples must all be strictly positive."
assert np.all(Q_samples > 0), "Q samples must all be strictly positive."
assert np.all(V1_samples > 0), "V1 samples must all be strictly positive."
assert np.all(V2_samples > 0), "V2 samples must all be strictly positive."

assert np.isclose(np.mean(CL_samples), CL_mean, rtol = .10)