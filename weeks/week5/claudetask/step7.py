...
good_result = least_squares(residuals, [1, 0.5, 8], bounds = ([0.05, 0, 3], [15, 15, 20]))
print("Good results:", good_result)
print("Bad results:", bad_result)

assert np.allclose(good_result.x, bad_result.x, atol = 1e-5)