...
#--------
#5. LOCAL SENSITIVITY CHECK
#--------
#baseline result
baseline_result = run_pipeline(100.0, default_params)
#changed result
perturbed_CL = default_params._replace(CL = default_params.CL *1.10)
perturbed_CL_result = run_pipeline(100.0, perturbed_CL)
#Q
perturbed_Q = default_params._replace(Q = default_params.Q *1.10)
perturbed_Q_result = run_pipeline(100.0, perturbed_Q)
#V1
perturbed_V1 = default_params._replace(V1 = default_params.V1 *1.10)
perturbed_V1_result = run_pipeline(100.0, perturbed_V1)
#V2
perturbed_V2 = default_params._replace(V2 = default_params.V2 *1.10)
perturbed_V2_result = run_pipeline(100.0, perturbed_V2)
###
baseline_auc = baseline_result["auc_0_48"]
change_CL = ((perturbed_CL_result["auc_0_48"] - baseline_auc) / baseline_auc) * 100
change_Q = ((perturbed_Q_result["auc_0_48"] - baseline_auc) / baseline_auc) * 100
change_V1 = ((perturbed_V1_result["auc_0_48"] - baseline_auc) / baseline_auc) * 100
change_V2 = ((perturbed_V2_result["auc_0_48"] - baseline_auc) / baseline_auc) * 100
changes = {
    "CL": change_CL,
    "Q": change_Q,
    "V1": change_V1,
...
print("\nSensitivity Ranking:")
for parameter, change in ranked_changes:
    print(f"{parameter}: {change:.2f}%")
