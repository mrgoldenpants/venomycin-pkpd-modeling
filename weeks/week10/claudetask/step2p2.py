...
#--------
def perturb_parameter(params, parameter_name, percent = 0.10):
    """increase one parameter by 10%"""
    old_value = getattr(params, parameter_name)
    new_value = old_value *(1+percent)
    return params._replace(**{parameter_name: new_value})



test_params =perturb_parameter(default_params, "CL", 0.10)
assert test_params.CL == default_params.CL*1.10
assert test_params.Q == default_params.Q
assert test_params.V1 == default_params.V1
assert test_params.V2 == default_params.V2
