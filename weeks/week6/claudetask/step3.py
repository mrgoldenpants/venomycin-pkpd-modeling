...
def weighted_residuals(theta, observed_time, observed_concentration):
    CL, Q, V1 = theta
    V2 = 15
    y0 = np.array([100, 0])
    ...
    A1 = predicted_solution.y[0]
    predicted_concentration = A1 / V1
    return (observed_concentration - predicted_concentration)/observed_concentration
for subject in subjects:
    ...
    unweighted = least_squares(residuals, initial_guess, args=(observed_time, observed_concentration))
    weighted = least_squares(weighted_residuals, initial_guess, args=(observed_time, observed_concentration))
    print("Subject ", subject)
    print("Unweighted:", unweighted.x)
    print("Weighted:", weighted.x)