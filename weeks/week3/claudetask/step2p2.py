...
#the two below are just using two different solvers for the ODE
...
#solution_RK45.y[0] is just the first row
...
plt.show()
# we used allclose because its an array
assert np.allclose(solution_RK45.y[:, -1], solution_radau.y[:, -1], atol=1e-4)