...
> The diagram should represent the model actually implemented here. Do not include an absorption-rate parameter such as `k_a`, because the IV bolus formulation does not contain an absorption compartment.
...
![Population target attainment](figures/population_attainment.png)
